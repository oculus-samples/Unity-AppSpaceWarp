...
To run the demo, clone this repo and open it in *Unity 6000.0.66f2* or higher. Load the [Assets/AppSpaceWarp/Scenes/OpaqueObjects](Assets/AppSpaceWarp/Scenes/OpaqueObjects.unity) scene.
